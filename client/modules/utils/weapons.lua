core.utils.getWeaponFromHash = function(hash)
	weapons = {
		['-102973651'] = 'Hatchet',
		['-1834847097'] = 'Dagger',
	...
	return weapons[hash] or 'unknown'
end

core.utils.getWeaponTypeGroup = function(hash)
	local weaponType = GetWeapontypeGroup(hash)
	local weaponTypes = {

	}
	return weaponTypes[weaponType] or 'unknown'
end